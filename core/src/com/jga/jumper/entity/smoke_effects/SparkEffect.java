...
public class SparkEffect extends EntityBase implements Pool.Poolable {
...
//        currentState = GameConfig.TRAP_WARNING_SMOKE_SPAWN_STATE;
        ...
        public boolean hasSparkAnimationStarted() {
            return hasAnimationStarted;
        }

        public void setHasSparkAnimationStarted(boolean hasSparkAnimationStarted) {
            this.hasAnimationStarted = hasSparkAnimationStarted;
        }
    }
